...
https://github.com/adewg/ICAR/blob/v1.5.0/resources/icarMovementDepartureEventResource.json
"""
...
async def create_departure_event(
    request: Request,
    departure: Departure,
...
async def remove_departure_event(
    request: Request,
