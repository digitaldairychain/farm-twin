...
async def arrival_event_query(
    ...
    lastCalvingDateEnd: datetime | None = datetime.now(),
    lastInseminationDateStart: datetime | None = datetime(1970, 1, 1, 0, 0, 0),
    lastInseminationDateEnd: datetime | None = datetime.now(),
    lastDryingOffDateStart: datetime | None = datetime(1970, 1, 1, 0, 0, 0),
    lastDryingOffDateEnd: datetime | None = datetime.now(),
