...
https://github.com/adewg/ICAR/blob/v1.5.0/resources/icarReproHeatEventResource.json
"""
...
async def create_repro_heat_event(
    request: Request,
    repro_heat: ReproHeat,
    ...
    return await add_one_to_db(
        repro_heat, request.app.state.repro_heat, ERROR_MSG_OBJECT
    )
...
async def repro_heat_event_query(
    ...
    heatDetectionMethod: icarEnums.icarReproHeatDetectionMethodType
    | None = None,
