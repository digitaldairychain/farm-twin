...
class icarDeviceManufacturerType(BaseModel):
    ...
    deviceConfiguration: Optional[str] = Field(
        default=None, json_schema_extra={"description": "Configuration of the device."}
    )
...
class icarAnimalStateType(BaseModel):
    ...
    lastCalvingDate: Optional[datetime] = Field(default=None)
    lastInseminationDate: Optional[datetime] = Field(default=None)
    lastDryingOffDate: Optional[datetime] = Field(default=None)


class icarOrganizationIdentityType(BaseModel):
    name: str = Field(json_schema_extra={"description": "Name of the organisation"})
...
class icarConsignmentType(BaseModel):
    ...
    id: Optional[icarIdentifierType] = Field(
        default=None, json_schema_extra={"Official identifier for the movement."}
    )
    ...
    originAddress: Optional[str] = Field(
        default=None, json_schema_extra={"Origin address for movement."}
    )
    ...
    destinationAddress: Optional[str] = Field(
        default=None, json_schema_extra={"Destination address for movement."}
    )
    ...
    expectedDuration: Optional[float] = Field(
        default=None,
        json_schema_extra={"Expected duration of transportation in hours."},
    )
    ...
    transportReference: Optional[str] = Field(
        default=None, json_schema_extra={"Shipping or transporter reference."}
    )
    isolationFacilityUsed: Optional[bool] = Field(
        default=None,
        json_schema_extra={"True if an isolation facility was used for the movement."},
    )
    farmAssuranceReference: Optional[icarIdentifierType] = Field(
        default=None,
        json_schema_extra={"Identification reference of a farm assurance operation."},
    )
    ...
    countReceived: Optional[int] = Field(
        default=None,
        json_schema_extra={"The number of animals received at the destination."},
    )
