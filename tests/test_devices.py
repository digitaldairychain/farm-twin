class TestDevices:
    def test_create_get_device(self, test_client, device_payload):
        ...
        assert response_json["vendor"] == device_payload["vendor"]
        assert response_json["model"] == device_payload["model"]
    ...
    def test_create_update_device(
        ...
        assert response_json["vendor"] == device_payload_updated["vendor"]
        assert response_json["model"] == device_payload_updated["model"]
